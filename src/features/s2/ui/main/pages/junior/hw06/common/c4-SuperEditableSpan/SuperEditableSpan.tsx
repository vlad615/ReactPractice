import React, { type DetailedHTMLProps, type InputHTMLAttributes, type HTMLAttributes, useState } from 'react'
import s from './SuperEditableSpan.module.css'
import SuperInputText from '@/commun/components/c1-SuperInputText/SuperInputText'
